...
class SearchConfig(Config):
  ...
  train_batch_size: Param =         FixedParam(int(32))
  eval_batch_size: Param =          FixedParam(int(32))
  num_epochs: Param =               FixedParam(int(1))
  evaluations_per_epoch: Param =    FixedParam(int(100))
...
class DebugSearchConfig(SearchConfig):
  ...
  num_epochs: Param =               FixedParam(int(0))  # Don't train at all.
  evaluations_per_epoch: Param =    FixedParam(int(1))

  embed_dim: Param =                FixedParam(int(8))  # Teeny tiny model.
  num_heads: Param =                FixedParam(int(8))
  depth: Param =                    FixedParam(int(2))
  mlp_ratio: Param =                FixedParam(4.0)
  causal: Param =                   FixedParam(True)

  num_train_classes: Param =        FixedParam(int(80))
  num_valid_classes: Param =        FixedParam(int(20))
  num_test_classes: Param =         FixedParam(int(16))
  prop_train_labels: Param =        FixedParam(.8)
  prop_valid_labels: Param =        FixedParam(.7)
  ...
  num_exemplars_per_class: Param =  FixedParam(int(20))
  ...
  train_context_len: Param =        FixedParam(int(2))
...
class SymbolicSearchConfig(SearchConfig):
  ...
  embed_dim: Param =                FixedParam(int(64))
  num_heads: Param =                FixedParam(int(8))
  depth: Param =                    FixedParam(int(2))
  mlp_ratio: Param =                FixedParam(4.0)
  causal: Param =                   FixedParam(True)

  num_train_classes: Param =        FixedParam(int(1600))
  num_valid_classes: Param =        FixedParam(int(2))
  num_test_classes: Param =         FixedParam(int(2))
